...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/22 17:23:25 by oel-bour          #+#    #+#             */
/*   Updated: 2020/02/22 17:23:26 by oel-bour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::setDetailes(const std::string name, int hit_points,int max_hit_points,
...
{
    std::cout << "Clap-TP " + this->name + " get damaged by an amount of ";
